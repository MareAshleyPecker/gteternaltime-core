...
object ETGtoCasingBlocks {
        ...
        return OnlyETreg.ETRegistrate.block(name) { p: BlockBehaviour.Properties -> Block(p) }
            ...
            .exBlockstate { ctx, prov ->
                val model = prov.models()
                    .withExistingParent(
                        ctx.name,
                        ResourceLocation.fromNamespaceAndPath("gtceu", "block/cube_2_layer/bottom_top")
                    )
    ...
    val CHEMICAL_GRADE_GLASS: BlockEntry<GlassBlock?> =
        createGlassCasingBlock(
            "chemical_grade_glass",
            "化学级玻璃",
            GtocoreAssets.gtocoreTexture("block/casings/chemical_grade_glass")
        )
    ...
    val PLASMA_FIELD_GLASS: BlockEntry<GlassBlock?> =
        createGlassCasingBlock(
            "plasma_field_glass",
            "等离子体场玻璃",
            GtocoreAssets.gtocoreTexture("block/casings/plasma_field_glass")
        )
    ...
    val AMPROSIUM_PIPE_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "amprosium_pipe_casing",
            "安普洛管道方块",
            GtocoreAssets.gtocoreTexture("block/neutronium_pipe_casing")
        )
    ...
    val IRIDIUM_PIPE_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "iridium_pipe_casing",
            "铱管道方块",
            GtocoreAssets.gtocoreTexture("block/machine_casing_pipe_iridium")
        )
    ...
    val INCONEL_625_PIPE: BlockEntry<Block?> =
        createCasingBlock(
            "inconel_625_pipe",
            "镍铬基合金-625温和分散管道",
            GtocoreAssets.gtocoreTexture("block/inconel_625_pipe")
        )
    ...
    val HASTELLOY_N_75_PIPE: BlockEntry<Block?> =
        createCasingBlock(
            "hastelloy_n_75_pipe",
            "哈斯特洛依合金-N75油膜管道",
            GtocoreAssets.gtocoreTexture("block/hastelloy_n_75_pipe")
        )
    ...
    val AMPROSIUM_GEARBOX: BlockEntry<Block?> =
        createCasingBlock(
            "amprosium_gearbox",
            "安普洛齿轮箱机械方块",
            GtocoreAssets.gtocoreTexture("block/neutronium_gearbox")
        )
    ...
    val IRIDIUM_GEARBOX: BlockEntry<Block?> =
        createCasingBlock(
            "iridium_gearbox",
            "铱齿轮箱机械方块",
            GtocoreAssets.gtocoreTexture("block/machine_casing_gearbox_iridium")
        )
    ...
    val INCONEL_625_GEARBOX: BlockEntry<Block?> =
        createCasingBlock(
            "inconel_625_gearbox",
            "镍铬基合金-625球磨齿轮箱",
            GtocoreAssets.gtocoreTexture("block/inconel_625_gearbox")
        )
    ...
    val LASER_COOLING_CASING: BlockEntry<Block?> =
        createCasingBlock(
            ...
            "激光冷却方块",
            GtocoreAssets.gtocoreTexture("block/laser_cooling_casing")
        )

    val HIGH_ENERGY_LASER_EMITTER: BlockEntry<Block?> =
        createCasingBlock(
            "high_energy_laser_emitter",
            "高能激光发射器",
            GtocoreAssets.gtocoreTexture("block/high_energy_laser_emitter")
        )
    ...
    val DIMENSIONAL_BRIDGE_CASING: BlockEntry<Block?> =
        createCasingBlock(
            ...
            "维度桥接方块",
            GtocoreAssets.gtocoreTexture("block/dimensional_bridge_casing")
        )
    ...
    val ACCELERATED_PIPELINE: BlockEntry<Block?> =
        createCasingBlock(
            ...
            "加速管道",
            GtocoreAssets.gtocoreTexture("block/accelerated_pipeline")
        )
    ...
    val MACHINE_CASING_GRINDING_HEAD: BlockEntry<Block?> =
        createCasingBlock(
            "machine_casing_grinding_head",
            "坚固钻头",
            GtocoreAssets.gtocoreTexture("block/machine_casing_grinding_head")
        )

    val CREATE_HPCA_COMPONENT: BlockEntry<Block?> =
        createCasingBlock(
            "create_hpca_component",
            "创造计算组件",
            GtocoreAssets.gtocoreTexture("block/create_hpca_component")
        )
    ...
    val STEAM_ASSEMBLY_BLOCK: BlockEntry<Block?> =
        createCasingBlock(
            ...
            "蒸汽装配方块",
            GtocoreAssets.gtocoreTexture("block/steam_assembly_block")
        )
    ...
    val MODULE_CONNECTOR: BlockEntry<Block?> =
        createCasingBlock(
            "module_connector",
            "太空电梯模块连接器",
            GtocoreAssets.gtocoreTexture("block/module_connector")
        )
    ...
    val RED_STEEL_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "red_steel_casing",
            "高气密红钢机器外壳",
            GtocoreAssets.gtocoreTexture("block/casings/red_steel_casing")
        )
    ...
    val IRIDIUM_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "iridium_casing",
            "铱强化机械方块",
            GtocoreAssets.gtocoreTexture("block/casings/iridium_casing")
        )
    ...
    val PROCESS_MACHINE_CASING: BlockEntry<Block?> = createCasingBlock(
            ...
            "处理机械方块",
            GtocoreAssets.gtocoreTexture("block/casings/process_machine_casing")
        )
    ...
    val MAGTECH_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "magtech_casing",
            "磁力机械方块",
            GtocoreAssets.gtocoreTexture("block/casings/magtech_casing")
        )
    ...
    val COMPRESSOR_PIPE_CASING: BlockEntry<Block?> =
        createCasingBlock(
            ...
            "压缩管道机械方块",
            GtocoreAssets.gtocoreTexture("block/compressor_pipe_casing")
        )
    ...
    val EXTREME_DENSITY_CASING: BlockEntry<Block?> =
        createCasingBlock(
            ...
            "极密机械方块",
            GtocoreAssets.gtocoreTexture("block/extreme_density_casing")
        )
    ...
    val FLOCCULATION_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "flocculation_casing",
            "光滑无菌絮凝机械方块",
            GtocoreAssets.gtocoreTexture("block/flocculation_casing")
        )
    ...
    val PLASMA_HEATER_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "plasma_heater_casing",
            "等离子加热机械方块",
            GtocoreAssets.gtocoreTexture("block/plasma_heater_casing")
        )
    ...
    val SHIELDED_ACCELERATOR: BlockEntry<Block?> =
        createCasingBlock(
            "shielded_accelerator",
            "屏蔽加速器机械方块",
            GtocoreAssets.gtocoreTexture("block/shielded_accelerator")
        )

    val AMPROSIUM_ACTIVE_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "amprosium_active_casing",
            "安普洛活性机械方块",
            GtocoreAssets.gtocoreTexture("block/neutronium_active_casing")
        )

    val QUARK_PIPE: BlockEntry<Block?> =
        createCasingBlock("quark_pipe", "夸克管道", GtocoreAssets.gtocoreTexture("block/quark_pipe"))
    ...
    val NEUTRONIUM_STABLE_CASING: BlockEntry<Block?> =
        createCasingBlock(
            ...
            "中子稳定机械方块",
            GtocoreAssets.gtocoreTexture("block/neutronium_stable_casing")
        )
    ...
    val ABS_BLUE_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "abs_blue_casing",
            "蓝色ABS塑料机械外壳",
            GtocoreAssets.gtocoreTexture("block/casings/abs_blue_casing")
        )
    ...
    val ABS_BROWN_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "abs_brown_casing",
            "棕色ABS塑料机械外壳",
            GtocoreAssets.gtocoreTexture("block/casings/abs_brown_casing")
        )
    ...
    val ABS_GREEN_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "abs_green_casing",
            "绿色ABS塑料机械外壳",
            GtocoreAssets.gtocoreTexture("block/casings/abs_green_casing")
        )
    ...
    val ABS_GREY_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "abs_grey_casing",
            "灰色ABS塑料机械外壳",
            GtocoreAssets.gtocoreTexture("block/casings/abs_grey_casing")
        )
    ...
    val ABS_LIME_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "abs_lime_casing",
            "黄绿色ABS塑料机械外壳",
            GtocoreAssets.gtocoreTexture("block/casings/abs_lime_casing")
        )
    ...
    val ABS_ORANGE_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "abs_orange_casing",
            "橙色ABS塑料机械外壳",
            GtocoreAssets.gtocoreTexture("block/casings/abs_orange_casing")
        )
    ...
    val ABS_RED_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "abs_red_casing",
            "红色ABS塑料机械外壳",
            GtocoreAssets.gtocoreTexture("block/casings/abs_red_casing")
        )
    ...
    val ABS_WHITE_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "abs_white_casing",
            "白色ABS塑料机械外壳",
            GtocoreAssets.gtocoreTexture("block/casings/abs_white_casing")
        )
    ...
    val ABS_YELLOW_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "abs_yellow_casing",
            "黄色ABS塑料机械外壳",
            GtocoreAssets.gtocoreTexture("block/casings/abs_yellow_casing")
        )
    ...
    val ABS_CYAN_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "abs_cyan_casing",
            "青色ABS塑料机械外壳",
            GtocoreAssets.gtocoreTexture("block/casings/abs_cyan_casing")
        )
    ...
    val ABS_MAGENTA_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "abs_magenta_casing",
            "品红色ABS塑料机械外壳",
            GtocoreAssets.gtocoreTexture("block/casings/abs_magenta_casing")
        )
    ...
    val ABS_PINK_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "abs_pink_casing",
            "粉色ABS塑料机械外壳",
            GtocoreAssets.gtocoreTexture("block/casings/abs_pink_casing")
        )
    ...
    val ABS_PURPLE_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "abs_purple_casing",
            "紫色ABS塑料机械外壳",
            GtocoreAssets.gtocoreTexture("block/casings/abs_purple_casing")
        )
    ...
    val TRANSMUTATION_CATALYST: BlockEntry<Block?> =
        createCasingBlock(
            ...
            "嬗变催化器",
            GtocoreAssets.gtocoreTexture("block/casings/transmutation_catalyst")
        )
    ...
    val INFUSED_GOLD_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "infused_gold_casing",
            "注魔金外壳",
            GtocoreAssets.gtocoreTexture("block/casings/infused_gold_casing")
        )
    ...
    val SOURCE_STONE_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "source_stone_casing",
            "魔源机械方块",
            GtocoreAssets.gtocoreTexture("block/casings/source_stone_casing")
        )
    ...
    val SPELL_PRISM_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "spell_prism_casing",
            "法术机械方块",
            GtocoreAssets.gtocoreTexture("block/casings/spell_prism_casing")
        )

    val ORIGINAL_BRONZE_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "original_bronze_casing",
            "原始青铜外壳",
            GtocoreAssets.gtocoreTexture("block/casings/original_bronze_casing")
        )
    ...
    val MANASTEEL_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "manasteel_casing",
            "魔力钢外壳",
            GtocoreAssets.gtocoreTexture("block/casings/manasteel_casing")
        )
    ...
    val TERRASTEEL_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "terrasteel_casing",
            "泰拉钢外壳",
            GtocoreAssets.gtocoreTexture("block/casings/terrasteel_casing")
        )
    ...
    val ELEMENTIUM_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "elementium_casing",
            "源质钢外壳",
            GtocoreAssets.gtocoreTexture("block/casings/elementium_casing")
        )
    ...
    val ALFSTEEL_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "alfsteel_casing",
            "精灵钢外壳",
            GtocoreAssets.gtocoreTexture("block/casings/alfsteel_casing")
        )
    ...
    val GAIASTEEL_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "gaiasteel_casing",
            "盖亚钢外壳",
            GtocoreAssets.gtocoreTexture("block/casings/gaiasteel_casing")
        )
    ...
    val ORICHALCOS_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "orichalcos_casing",
            "奥利哈钢外壳",
            GtocoreAssets.gtocoreTexture("block/casings/orichalcos_casing")
        )
    ...
    val COOLANT_PIPE_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "coolant_pip_casing",
            "冷却液管道机械方块",
            GtocoreAssets.gtocoreTexture("block/casings/coolant_pip_casing")
        )
    ...
    val STABLE_BASE_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "stable_base_casing",
            "稳定底座机械方块",
            GtocoreAssets.gtocoreTexture("block/casings/stable_base_casing")
        )
    ...
    val THE_ORIGIN_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "the_origin_casing",
            "起源之铭符",
            GtocoreAssets.gtocoreTexture("block/casings/the_origin_casing")
        )
    ...
    val THE_CHAOS_CASING: BlockEntry<Block?> =
        createCasingBlock(
            "the_chaos_casing",
            "混沌之铭符",
            GtocoreAssets.gtocoreTexture("block/casings/the_chaos_casing")
        )
    ...
    val THE_SOLARIS_LENS: BlockEntry<GlassBlock?> =
        createGlassCasingBlock(
            "the_solaris_lens",
            "天辉凝聚之镜",
            GtocoreAssets.gtocoreTexture("block/casings/the_solaris_lens")
        )
    ...
    val MACHINING_CONTROL_CASING_MK1: BlockEntry<Block?> = createSidedBloomCasingBlock(
        "machining_control_casing_mk1",
        "运行控制方块 MK I",
        GtocoreAssets.gtocoreTexture("block/casings/sided/machining_control_casing_mk1")
    )

    val MACHINING_CONTROL_CASING_MK2: BlockEntry<Block?> = createSidedBloomCasingBlock(
        "machining_control_casing_mk2", "运行控制方块 MK II",
        GtocoreAssets.gtocoreTexture("block/casings/sided/machining_control_casing_mk2")
    )

    val MACHINING_CONTROL_CASING_MK3: BlockEntry<Block?> = createSidedBloomCasingBlock(
        "machining_control_casing_mk3", "运行控制方块 MK III",
        GtocoreAssets.gtocoreTexture("block/casings/sided/machining_control_casing_mk3")
    )

    val FUSION_CASING_MK4: BlockEntry<Block?> = createCasingBlock(
        "fusion_casing_mk4", "聚变机械方块 MK IV",
        GtocoreAssets.gtocoreTexture("block/casings/fusion/fusion_casing_mk4")
    )

    val FUSION_CASING_MK5: BlockEntry<Block?> = createCasingBlock(
        "fusion_casing_mk5", "聚变机械方块 MK V",
        GtocoreAssets.gtocoreTexture("block/casings/fusion/fusion_casing_mk5")
    )

    val ENERGETIC_PHOTOVOLTAIC_BLOCK: BlockEntry<Block?> = createCasingBlock(
        "energetic_photovoltaic_block", "充能光伏方块",
        GtocoreAssets.gtocoreTexture("block/energetic_photovoltaic_block")
    )

    val PULSATING_PHOTOVOLTAIC_BLOCK: BlockEntry<Block?> = createCasingBlock(
        "pulsating_photovoltaic_block", "脉冲光伏方块",
        GtocoreAssets.gtocoreTexture("block/pulsating_photovoltaic_block")
    )

    val VIBRANT_PHOTOVOLTAIC_BLOCK: BlockEntry<Block?> = createCasingBlock(
        "vibrant_photovoltaic_block", "振动光伏方块",
